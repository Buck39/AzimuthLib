...
meta =
{
    ...
    name = "AzimuthLib-Revisited",

    -- Title of your mod that will be displayed to players
    title = "AzimuthLib - Library for modders - Revisited",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A resource for modders that provides functions to make mod development easier.",
